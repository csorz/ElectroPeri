        ...
        {activeTab === 'demo' && (
          <div className="demo-section">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              ...
              <button onClick={() => onCopy(css)} style={{ padding: '4px 12px', fontSize: '12px', background: '#e0e0e0', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>复制 CSS</button>
            </div>
            <pre style={{ background: '#1e1e1e', color: '#d4d4d4', padding: '12px', borderRadius: '6px', fontSize: '13px', overflow: 'auto' }}>
              {`.shadow {\n  ${css}\n}`}
            </pre>
          </div>
        )}
